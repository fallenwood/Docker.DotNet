...
internal class ExecOperations : IExecOperations
{
    ...
    public async Task<ContainerExecCreateResponse> ExecCreateContainerAsync(string id, ContainerExecCreateParameters parameters, CancellationToken cancellationToken = default(CancellationToken))
    {
        ...
        var data = new JsonRequestContent<ContainerExecCreateParameters>(parameters, this._client.JsonSerializer.ContainerExecCreateParameters);
        ...
        return JsonSerializer.Deserialize(response.Body, this._client.JsonSerializer.ContainerExecCreateResponse);
    }
    ...
    public async Task<ContainerExecInspectResponse> InspectContainerExecAsync(string id, CancellationToken cancellationToken)
    {
        ...
        return JsonSerializer.Deserialize(response.Body, this._client.JsonSerializer.ContainerExecInspectResponse);
    }
    ...
    public Task StartContainerExecAsync(string id, CancellationToken cancellationToken)
    {
        ...
        var data = new JsonRequestContent<ContainerExecStartParameters>(parameters, this._client.JsonSerializer.ContainerExecStartParameters);
    ...
    public async Task<MultiplexedStream> StartWithConfigContainerExecAsync(string id, ContainerExecStartParameters eConfig, CancellationToken cancellationToken)
    {
        ...
        var data = new JsonRequestContent<ContainerExecStartParameters>(eConfig, this._client.JsonSerializer.ContainerExecStartParameters);
